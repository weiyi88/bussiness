...
class ListView
{
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        $maininfo = "<li><span class=\"pageinfo\">共{$totalpage}页</span></li>\r\n";
        ...
        //获得上一页和下一页的链接
        if($this->PageNo != 1)
        {if($this->PageNo == 2) { $prepage.="<li><a href='".$this->TypeID.".html'>上一页</a></li>\r\n"; }else{
            $prepage.="<li><a href='".$this->TypeID."-$prepagenum.html'>上一页</a></li>\r\n";}
            $indexpage="<li><a href='".$this->TypeID.".html'>首页</a></li>\r\n";
        }
		
        else
        {
            $indexpage="<li><a style='background:#ededed;color:#333;'>首页</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a href='".$this->TypeID."-$nextpagenum.html'>下一页</a></li>\r\n";
            $endpage="<li><a href='".$this->TypeID."-$totalpage.html'>末页</a></li>\r\n";
        }
        else
        {
            $endpage="<li><a style='background:#ededed;color:#333;'>末页</a></li>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<li><a href='".$this->TypeID."-$j.html'>".$j."</a></li>\r\n";
            }
        }
