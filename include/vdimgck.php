...
require_once  (dirname(__FILE__).'/../tqydt/data/safe/inc_safe_config.php');
require_once  (dirname(__FILE__).'/../tqydt/data/config.cache.inc.php');
$config = array(
    'font_size'   => 14,
    ...
    'filter_type' => 5);
$sessSavePath = dirname(__FILE__)."/../tqydt/data/sessions/";
