...
require_once(dirname(__FILE__)."/../inc5@dd/dedemodule.class.php");
require_once(dirname(__FILE__)."/../inc5@dd/oxwindow.class.php");
...
if($action=='upload')
{
    ...
    {
        include_once(dirname(__FILE__)."/../inc5@dd/zip.class.php");
